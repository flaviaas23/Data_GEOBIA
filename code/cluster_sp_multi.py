...
def run_clarans(arraybands_list_sel):
    '''
    Clarans initialization and execution
    '''
    ...
    clarans_instance_img_sel.process
    ...
    return clusters_sel#, medoids_sel
...
if __name__ == '__main__':
    ...
    for n in tqdm(range(2, n_clusters+1)):
        ...
        clusters_sel = run_clarans(arraybands_list_sel)
