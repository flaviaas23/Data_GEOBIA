...
save in parquet files the PCA images to be used in segmentation
'''
#%%
#### Imports
...
# SAVE_PCA_DF=0           #0: save files
#                         #1: read df to pca parquet files 
# if SAVE_PCA_DF == 0:
#     save_path = cur_dir + '/data/parquet_npart111514/'
...
# elif SAVE_PCA_DF == 1: #read pca parquet files
#     #### read parquet files
#     read_parquet = cur_dir + '/data/parquet_npart111514/'
#     #f_name = name_img+'_df_toPCA_full.parquet'
#     f_name = name_img+'_pca_df_npart111514'
...
# pca_components_df_merge= dd.merge(df_toPCA_coords,pca_components_df,  on= 'index_orig', how='left')
...
# print ('pca_components_df_merge.dtypes:\n',pca_components_df_merge.dtypes) if sh_print_n2 else None
# #salvar este df
# SAVE_PCA_DF=0
# if SAVE_PCA_DF:
#     save_path = cur_dir + '/data/parquet_npart111514/'
...
print (f'gen img_pca ...') if sh_print_n1 else None
t1=time.time()
for c in comps_sel:
...
for c in comps_sel:
    save_path = cur_dir + '/data/parquet_npart111514/'
    f_name = name_img+'_'+c+'_img_pca_npart111514_'
...
t3=time.time()
print (f'time to save img pca {c} to parquet file: {t3-t0}s, {(t3-t0)/60} m') if sh_print_n1 else None
#fazer snic
